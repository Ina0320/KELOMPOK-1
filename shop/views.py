...
def index(request):
    # Mengambil produk terbaru, bisa disesuaikan dengan filter atau urutan
    products = Product.objects.all().order_by('-created_at')[:8]  # Ambil 8 produk terbaru
    categories = Kategori.objects.all()  # Mengambil semua kategori produk
...
def category_list(request):
   categories = Kategori.objects.all()  # Mengambil semua kategori yang ada
